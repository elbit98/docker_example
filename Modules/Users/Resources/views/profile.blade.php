                    ...
                    <div class="q-profile__form">
                        <div class="q-profile__col _av-col">
                            <div class="q-user__avatar-profile _text-center">
                                <div class="q-user__avatar _large _edit q-user-white-border">
                                    <img src="{{ asset($user->avatar) }}" alt="" class="q-user__avatar-img">
                                    <span class="q-user__avatar--edit-btn"></span>
                                    <span onclick="updateAvatar()" class="q-user__avatar--edit-text">Изменить <br/> аватар</span>
                                </div>
                            </div>
                        ...
                        <div class="q-profile__col _left-col">
                            <div class="q-form__row">
                                ...
                                <div class="q-form__input--wrapper">
                                    <input id="profileLogin" type="text" value="{{ $user->full_name }}" placeholder="" class="q-form__input q-form-white"/>
                            ...
                            <div class="q-form__row">
                                ...
                                <div class="q-form__input--wrapper">
                                    <input id="profileEmail" type="text" value="{{ $user->email }}" placeholder="" disabled="disabled" class="q-form__input q-form-white"/>
                        ...
                        <div class="q-profile__col _right-col">
                            ...
                            <div class="q-form__row">
                                ...
                                <div class="q-form__input--wrapper">
                                    <input id="profilePassword" type="password" placeholder="Новый пароль" class="q-form__input q-form-white"/>

                                    <i class="q-icon q-icon-success"></i>
                                </div>
                            </div>
                            <div class="q-form__row">
                                <label for="profilePasswordRetry" class="q-form__label">Новый пароль (повторно):</label>
                                <div class="q-form__input--wrapper">
                                    <input id="profilePasswordRetry" type="password" placeholder="Повтор пароля" class="q-form__input q-form-white"/>
