...
@section('content')
        ...
        <!-- end header -->
            ...
            <div class="q-breadcrumbs">
                <div class="q-inner">
                    <ul class="q-breadcrumbs__list">
                        ...
                        <li class="q-breadcrumbs__item">Тилимитряндия</li>
                    ...
                    <div class="q-filters-with-buttons">
                        ...
                        <div class="q-form__input--wrapper q-form__input--wrapper-right">
                            <div class="q-buttons__submit">
                                ...
                                <a href="#" class="q-button _white js-show-q-export-to-file-popup">Экспорт</a>
                            </div>
            ...
            <div class="q-inner">
                <div class="q-page__header--right-part">
                    ...
                    <ul class="q-tabs-links">
                        <li class="q-tabs-links__item  _active">
                            <a href="#" class="q-tabs-links__link">Блоки</a>
                        </li>
                        <li class="q-tabs-links__item">
                            <a href="#" class="q-tabs-links__link">Список</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="g-task">
                            ...
                            <div class="g-task-footer">
                                <div class="g-task-footer-date">
                                    12.09 - <span class="g-task-footer-date-normal">15.11</span>
                                </div>
    ...
    <div class="q-popup js-q-export-to-file-popup">
        <div class="q-popup__holder js-q-popup-holder">
            <h3 class="q-popup__title">Выберите вид экспорта</h3>
            <form class="q-form">
                <div class="q-form__row">
                    <div class="q-form__col">
                        <div class="q-checkbox">
                            <input id="subscriptions4" type="checkbox" name="subscriptionsPopup" class="q-checkbox__input"/>
                            <label for="subscriptions4" class="q-checkbox__label">Сохранить в CSV</label>
                        </div>
                        <div class="q-checkbox">
                            <input id="subscriptions5" type="checkbox" name="subscriptionsPopup" class="q-checkbox__input"/>
                            <label for="subscriptions5" class="q-checkbox__label">Сохранить в PDF</label>
                        </div>
                ...
                <div class="q-form__row _submit">
                    <button class="q-button _red">Экспорт</button>
                </div>
            </form>
            <div class="q-popup__close js-close-popup"></div>
        </div>
    </div>
    <!-- end of export-to-file-popup -->
